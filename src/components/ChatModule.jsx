...
const ChatModule = ({
    ...
    return (
        <div
            id="chat"
            className={`absolute w-full max-w-2xl px-6 py-4 pointer-events-auto transition-all duration-200 
        ...
        >
            ...
            <div className="flex flex-col gap-3 max-h-60 overflow-y-auto mb-4 scrollbar-hide mask-image-gradient relative z-10">
